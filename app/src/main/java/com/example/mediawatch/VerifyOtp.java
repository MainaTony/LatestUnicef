...
//                                Toast.makeText(VerifyOtp.this, "Member exists in database", Toast.LENGTH_SHORT).show();
//                                Intent intent = new Intent(VerifyOtp.this, MainActivity.class);
//                                startActivity(intent);
//                            } else{
//                                Toast.makeText(VerifyOtp.this, "Sorry, You don't exists in the database, please sign up", Toast.LENGTH_SHORT).show();
//                            }
//                        } catch (IOException e) {
//                            e.printStackTrace();
//                        }
